...
if($_SESSION['user'] == 'tenant' ){
  echo "<script>alert('You are not allowed to make payments');
                ...
                <div class= "paycontainer">
                    ...
                    <form action="#" method="POST">
                        <div class="payform">
				            ...
				            <br><br>
                            <label for="pamount" style = "color:black ; "><h3>Select Mode of payment</h3></label><br>
                            <select style="width:65%" class="field" name="paymode" placeholder="Select Mode of payment"  required>
                            <option value=""></option>
                            ...
                            <br>
                            <button class="btn-pay" name="ppaymnet">Pay ₹1500</button> 
                        </div>
...
if(isset($_POST['ppaymnet'])){
    ...
    $query = "UPDATE `payrecords` SET `pay-mode`='$_POST[paymode]',`Status`='Success' WHERE Flatno = '$_SESSION[Flatno]'";
