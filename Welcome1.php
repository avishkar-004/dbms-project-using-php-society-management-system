...
<input type="checkbox" id="check">
    ...
    <div class="content"> 
      ...
      $sql = "SELECT Username,Flatno,Usertype FROM registration where Username='$user_name'";
      ...
      echo '<div class="col-div-3">
        <div class="box">
          <p>'.$row['Username'].'<br><span>'.$row['Usertype'].'</span></p>
     ...
     <br><span>Your Flat No.</span></p>
      ...
      <div class="col-div-3">
        <div class="box">
          ...
          ?>
          <?php
            $sql = "SELECT Username,Usertype FROM registration where Flatno=".$Flatno." order by usertype";
            $result = $conn->query($sql);
            if($result->num_rows >0){
              while($row = $result->fetch_assoc()){
                echo "
