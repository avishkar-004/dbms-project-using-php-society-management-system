    ...
    <div class="container">
        ...
        <?php
            if(isset($_POST['update']))
            {
                ...
                if($usertype == "Owner"){
                $query = "UPDATE owner SET Username = '$Username', Email = '$email',Flatno='$flatno', MobileNo='$mobileno' WHERE Id='$Id'";
                }
                else{
                    $query = "UPDATE tenant SET Username = '$Username', Email = '$email',Flatno='$flatno', MobileNo='$mobileno' WHERE Id='$Id'";
                }
                $query_run = mysqli_query($connection,$query);
