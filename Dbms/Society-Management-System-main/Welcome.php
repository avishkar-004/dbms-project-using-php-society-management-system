...
<input type="checkbox" id="check">
    ...
    <div class="content"> 
      ...
      $sql = "SELECT * FROM owner where Flatno='$Flatno'";
      ...
      echo '<div class="col-div-3">
        <div class="box">
          <p>'.$row['Username'].'<br><span>Owner</span></p>
      ...
      <div class="col-div-3">
        <div class="box">
          ...
          <i class="fas fa-user-tie fa-2x" ></i>
            ...
            echo "O records found ! '$Flatno'";
          }

          $sql = "SELECT * FROM tenant where Flatno='$Flatno'";
      $result1 = $conn->query($sql);
          if($result1->num_rows >0){
            while($row = $result1->fetch_assoc()){
              echo '<div class="col-div-3">
              <div class="box">
                <p>'.$row['Username'].'<br><span>Tenant</span></p>
                <i class="far fa-user fa-2x"></i>
              </div>
            </div>';
            }
